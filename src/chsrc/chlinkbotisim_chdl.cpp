...
EXPORTCH int CLinkbotI_accelJointCycloidNB_chdl(void *varg) {
	ChInterp_t interp;
	ChVaList_t ap;
	class CLinkbotI *robot;
	int id;
...
EXPORTCH int CLinkbotI_driveAccelCycloidNB_chdl(void *varg) {
	ChInterp_t interp;
	ChVaList_t ap;
	class CLinkbotI *robot;
	double radius;
...
EXPORTCH int CLinkbotI_jumpJointTo_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *robot;
    robotJointId_t id;
...
EXPORTCH int CLinkbotI_jumpJointToNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *robot;
    robotJointId_t id;
...
EXPORTCH int CLinkbotI_jumpTo_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *robot;
    double angle1;
...
EXPORTCH int CLinkbotI_jumpToNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *robot;
    double angle1;
...
EXPORTCH int CLinkbotI_stopTwoJoints_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *robot;
    robotJointId_t id1;
...
EXPORTCH int CLinkbotI_stopThreeJoints_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *robot;
    robotJointId_t id1;
...
EXPORTCH int CLIG_accelJointCycloidNB_chdl(void *varg) {
	ChInterp_t interp;
	ChVaList_t ap;
	class CLinkbotIGroup *robot;
	int id;
...
EXPORTCH int CLIG_driveAccelCycloidNB_chdl(void *varg) {
	ChInterp_t interp;
	ChVaList_t ap;
	class CLinkbotIGroup *robot;
	double radius;
...
EXPORTCH int CLIG_jumpJointTo_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *robot;
    robotJointId_t id;
...
EXPORTCH int CLIG_jumpJointToNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *robot;
    robotJointId_t id;
...
EXPORTCH int CLIG_jumpTo_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *robot;
    double angle1;
...
EXPORTCH int CLIG_jumpToNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *robot;
    double angle1;
...
EXPORTCH int CLIG_setMotorPower_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *robot;
    robotJointId_t id;
...
EXPORTCH int CLIG_stop_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *robot;
    int retval;
...
EXPORTCH int CLIG_stopTwoJoints_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *robot;
    robotJointId_t id1;
...
EXPORTCH int CLIG_stopThreeJoints_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *robot;
    robotJointId_t id1;
