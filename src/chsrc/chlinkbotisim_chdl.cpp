...
EXPORTCH int CLinkbotI_driveJointTo_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *robot;
    robotJointId_t id;
    ...
    retval = robot->driveJointTo(id, angle);
    Ch_VaEnd(interp, ap);
    return retval;
}

EXPORTCH int CLinkbotI_driveJointToNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *robot;
    robotJointId_t id;
    ...
    id = Ch_VaArg(interp, ap, robotJointId_t);
    angle = Ch_VaArg(interp, ap, double);
    retval = robot->driveJointToNB(id, angle);
    Ch_VaEnd(interp, ap);
    return retval;
}

EXPORTCH int CLinkbotI_driveJointToDirect_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *robot;
    robotJointId_t id;
...
EXPORTCH int CLinkbotI_driveJointToDirectNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *robot;
    robotJointId_t id;
...
EXPORTCH int CLinkbotI_movexyToFunc_chdl(void *varg) {
	ChVaList_t ap;
	class CLinkbotI *robot;
	double x0;
	double xf;
...
EXPORTCH int CLinkbotI_movexyToPoly_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *robot;
    double x0;
...
EXPORTCH int CLinkbotI_movexyToPolyNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *robot;
    double x0;
...
EXPORTCH int CLIG_driveJointTo_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *robot;
    robotJointId_t id;
...
EXPORTCH int CLIG_driveJointToNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *robot;
    robotJointId_t id;
