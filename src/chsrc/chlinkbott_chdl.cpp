...
EXPORTCH int CLinkbotT_moveJointByPowerNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotT *robot;
    robotJointId_t id;
...
EXPORTCH int CLinkbotT_moveJointToByTrackPos_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotT *robot;
    robotJointId_t id;
...
EXPORTCH int CLinkbotT_moveJointToByTrackPosNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotT *robot;
    robotJointId_t id;
...
EXPORTCH int CLinkbotT_moveToByTrackPos_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotT *robot;
    double angle1;
...
EXPORTCH int CLinkbotT_moveToByTrackPosNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotT *robot;
    double angle1;
...
EXPORTCH int CLTG_moveJointByPowerNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotTGroup *robot;
    robotJointId_t id;
...
EXPORTCH int CLTG_moveJointToByTrackPos_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotTGroup *robot;
    robotJointId_t id;
...
EXPORTCH int CLTG_moveJointToByTrackPosNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotTGroup *robot;
    robotJointId_t id;
...
EXPORTCH int CLTG_moveToByTrackPos_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotTGroup *robot;
    double angle1;
...
EXPORTCH int CLTG_moveToByTrackPosNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotTGroup *robot;
    double angle1;
