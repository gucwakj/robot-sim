...
int CLinkbotTGroup::turnLeft(double angle) {
	turnLeftNB(angle);
	return moveWait();
}

int CLinkbotTGroup::turnLeftNB(double angle) {
	robots_t rtmp = _robots;
	while (rtmp) {
...
int CLinkbotTGroup::turnRight(double angle) {
	turnRightNB(angle);
	return moveWait();
}

int CLinkbotTGroup::turnRightNB(double angle) {
	robots_t rtmp = _robots;
	while (rtmp) {
