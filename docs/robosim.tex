...
tracking is enabled, green lines for robot trajectories will be drawn for each
robot.
...
The RoboSim scene responds to keyboad input as outlined in Table
...
only, without the robot displayed.
\begin{figure}[H]
	\begin{center}
